...
class Ticket: 
    ...
    def __init__(self,ticketNumber : int, flightNumber : int, price : int, departureTime : datetime, arriveTime : datetime, ticketBagage : KgBagage,arrivedCountry : Country, departureCountry : Country, departureCity : string, arrrivedCity : string): 
    ...
    def print(self):
        ...
        print('Цена билета:', self.__price)
    ...
    def get_ticketNumber(self) -> int:
        return self.__ticketNumber
    
    def subsidizeTheTicket(self, decreasePrice : int ):
        self.__price -= decreasePrice
    
    def get_ticketPrice(self):
        return self.__price
    
    def get_ArrivedCountry(self):
        return self.__arrivedCountry
    
    def get_DepartureCountry(self):
        return self.__departureCountry
    
    def get_ArrivalCity(self):
        return self.__arrivedCity
